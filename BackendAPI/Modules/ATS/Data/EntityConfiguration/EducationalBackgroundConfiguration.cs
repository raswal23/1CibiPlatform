...
public class EducationalBackgroundConfiguration : IEntityTypeConfiguration<EducationalBackground>
{
    public void Configure(EntityTypeBuilder<EducationalBackground> builder)
    {
        ...
        builder.Property(e => e.HighSchoolGraduationDate).HasMaxLength(100);
        builder.Property(e => e.HighSchoolDiploma).HasMaxLength(100);
        builder.Property(e => e.SeniorHighSchoolName).HasMaxLength(100);
        builder.Property(e => e.SeniorHighSchoolAddress).HasMaxLength(100);
        builder.Property(e => e.SeniorHighSchoolGraduationDate).HasMaxLength(100);
        builder.Property(e => e.SeniorHighSchoolDiploma).HasMaxLength(100);
        builder.Property(e => e.CollegeSchoolName).HasMaxLength(100);
        builder.Property(e => e.CollegeAddress).HasMaxLength(100);
        builder.Property(e => e.CollegeGraduationDate).HasMaxLength(100);
        builder.Property(e => e.CollegeDiploma).HasMaxLength(100);
        ...
        builder.Property(e => e.BachelorsGraduationDate).HasMaxLength(100);
        builder.Property(e => e.BachelorsDiploma).HasMaxLength(100);
        ...
        builder.Property(e => e.MastersGraduationDate).HasMaxLength(100);
        builder.Property(e => e.MastersDiploma).HasMaxLength(100);
        ...
        builder.Property(e => e.DoctorateGraduationDate).HasMaxLength(100);
        builder.Property(e => e.DoctorateDiploma).HasMaxLength(100);
        builder.Property(e => e.DoctorateDegree).HasMaxLength(100);
        builder.Property(e => e.DoctorateMajor).HasMaxLength(100);

        builder.Property(e => e.SchoolSpecificLOA)
               .IsRequired(false);
