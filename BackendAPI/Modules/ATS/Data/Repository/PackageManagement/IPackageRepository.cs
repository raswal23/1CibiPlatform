...
{
	Task<List<PackageDetailsDTO>> GetPackagesPageAsync(string? searchTerm, int? clientId, bool? autoChasing, string? afterPackageName, int take, CancellationToken cancellationToken);
	Task<long> CountPackagesAsync(string? searchTerm, int? clientId, bool? autoChasing, CancellationToken cancellationToken);
